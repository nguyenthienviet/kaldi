...
declare -a test=("viet")
declare -a train=("jackson" "theo" "nicolas")
...
do 
	...
	do 
		...
		do
			...
			utt="${k}_${j}_${i}"
			path="/home/viet/kaldi/eng_digits_test_viet/data/train/"
			file="$path${k}/$utt$end"
...
do 
	...
	do
		...
		do
			...
			utt="${k}_${j}_${i}"
			path="/home/viet/kaldi/eng_digits_test_viet/data/test/"
			file="$path${k}/$utt$end"
