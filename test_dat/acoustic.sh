...
declare -a arr=( "one" "two" "three" "four" "five" "six" "seven" "eight" "nine" "zero" )
user="viet"
...
do 
	...
	do 
		...
		do
			...
			utt="${k}_${j}_${i}"
			path="/home/viet/kaldi/test_dat/data/train/"
			file="$path${k}/$utt$end"
...
do 
	...
	do 
		...
		do
			...
			utt="${k}_${j}_${i}"
			path="/home/viet/kaldi/test_dat/data/test/"
			file="$path${k}/$utt$end"
