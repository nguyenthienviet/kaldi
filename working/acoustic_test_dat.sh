DATA_TEST="data/test_dat"
DATA_TRAIN="data/train_dat"

declare -a test=("dat")
declare -a train=("theo" "nicolas" "jackson")
...
echo "jackson m" >> test/spk2gender
echo "nicolas m
theo m" >> train/spk2gender
...
do 
	...
	do 
		...
		do
			...
			utt="${k}_${j}_${i}"
			path="/home/viet/kaldi/working/data/test/"
			file="$path${k}/$utt$end"
		...
		do
			...
			utt="${k}_${j}_${i}"
			path="/home/viet/kaldi/working/data/train/"
			file="$path${k}/$utt$end"
